...
<head>
  <meta charset="UTF-8">
  <title>Farmer's Brew - Login</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Georgia', serif; }
    ...
    .navbar {
      background: linear-gradient(to right, rgb(144,92,44), rgb(144,92,44));
      color: white;
      padding: 30px 40px;
      font-size: 24px;
      font-weight: bold;
    ...
    .forgot {
      font-size: 13px; color: rgb(144,92,44);
    ...
    .signup a {
      color: rgb(144,92,44); text-decoration: none; font-weight: bold;
    }
    .error {
...
<body>
  <div class="navbar">
    <a href="index.php" style="display: flex; align-items: center; text-decoration: none; color: white;">
      <span style="font-size: 1.5rem; font-weight: bold;">Farmer's Brew</span>
    </a>
  </div>
  <div class="container">
    <div class="login-box">
      <div class="left-panel">
        ...
        <h2>Farmer's Brew</h2>
        <p>"A small farm that turned into a coffee shop"</p>
      </div>
        ...
        <form method="post">
          ...
          <div style="position: relative;">
            ...
            <span onclick="const p=document.getElementById('password'); this.textContent=p.type==='password'?'Hide':'Show'; p.type=p.type==='password'?'text':'password';" 
                    style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer; font-size: 12px; color: rgb(144,92,44);">
                Show
            </span>
            </div>
          <div class="forgot">
