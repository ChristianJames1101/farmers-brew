<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      ...
      // Use JavaScript redirect since output has already started
      echo "<script>window.location.href = 'home.php?page=products';</script>";
      exit();
  }
  ...
  $images = array_filter(scandir('../uploads'), function($file) {
      return in_array(strtolower(pathinfo($file, PATHINFO_EXTENSION)), ['jpg', 'jpeg', 'png', 'gif','jfif','webp']);
  });
  ?>
