...
<head>
  <meta charset="UTF-8" />
  <title>Customer - Farmer's Brew</title>
  <style>
    body {
      margin: 0;
    ...
    .notifications-container {
      ...
      z-index: 1001;
      border-left: 6px solid rgb(144,92,44);
    ...
    .notification-item.unread {
      background: #e1f0d9;
      border-left-color: rgb(144,92,44);
      font-weight: 600;
    }
...
<div class="navbar">
  <div class="logo">
    <img src="home-logo.jpg" alt="Lyneth's Garden Logo" />
    <span>Farmer's Brew</span>
  </div>
  <div class="nav-links">
    ...
    <a href="home.php?page=products"><img src="plants.png" alt="Plants" style="vertical-align: middle; height: 20px; margin-right: 1px;">Products</a>
    <a href="home.php?page=cart"><img src="cart.png" alt="Cart" style="vertical-align: middle; height: 20px; margin-right: 1px;">Cart</a>
    <a href="home.php?page=orders"><img src="orders.png" alt="Orders" style="vertical-align: middle; height: 20px; margin-right: 1px;">Orders</a>
    <a href="home.php?page=account"><img src="acc.png" alt="Account" style="vertical-align: middle; height: 20px; margin-right: 1px;">Account</a>
